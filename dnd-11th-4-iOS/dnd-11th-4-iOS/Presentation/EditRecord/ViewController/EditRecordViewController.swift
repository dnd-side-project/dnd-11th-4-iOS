...
final class EditRecordViewController: UIViewController, View {

    typealias Reactor = EditRecordReactor
    ...
    private let completeButton = MDButton(backgroundColor: .gray40)
        .setText(attributedString: NSAttributedString.pretendardB16("기록 수정 완료"), color: .gray60)
    ...
    init(reactor: EditRecordReactor) {
    ...
    func bind(reactor: EditRecordReactor) {
