    ...
    private let textView: UITextView = {
        ...
        textView.text = """
            *< 맵땅 >*은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
            ○ 이 개인정보처리방침은 *2022년 11월 1일*부터 적용됩니다.
            ...
            **제4조(개인정보의 제3자 제공에 관한 사항)**① *< 포토서퍼 >은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.*
            ...
            **제8조(정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항)**
            ① 정보주체는 포토서퍼에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.
            ② 제1항에 따른 권리 행사는포토서퍼에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며  맵땅은(는) 이에 대해 지체 없이 조치하겠습니다.
            ...
            **「 개인정보 보호법 제18조 」**
            ...
            9. 형(形) 및 감호, 보호처분의 집행을 위하여 필요한 경우
            **제4조(개인정보의 제3자 제공에 관한 사항)**① *< 포토서퍼 >은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.*
            *② < 포토서퍼 >은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.*
            - *1. < 맵땅 >*
            - *개인정보를 제공받는 자 : 맵땅*
            - *제공받는 자의 개인정보 이용목적 : 이메일, 로그인ID, 이름, 서비스 이용 기록, 접속 로그, 접속 IP 정보, 사용자 데이터*
            - *제공받는 자의 보유.이용기간: 1년*
