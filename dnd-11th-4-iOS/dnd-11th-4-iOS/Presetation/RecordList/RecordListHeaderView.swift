...
final class RecordListHeaderView: UICollectionReusableView {
    ...
    private let countLabel = MDLabel(attributedString: NSAttributedString.pretendardSB14("전체"), color: .mapBlack)
    private let numberLabel = MDLabel(attributedString: NSAttributedString.pretendardSB14("(0)"), color: .gray70)
